...
@RouterOperations({
        @RouterOperation(
                ...
                operation =
                @Operation(
                        description = "Api-Key 헤더 인증 없는 API 테스트",
                        operationId = "NoneSecure",
                        tags = "Study",
                        responses = {
                                @ApiResponse(
                                        responseCode = "200",
                                        description = "Api-Key 헤더 인증 없는 API 테스트 정상 응답",
                                        content = {
                                                @Content(
                                ...
                                @ApiResponse(
                                        responseCode = "400",
                                        description = "Api-Key 헤더 인증 없는 API 테스트 400 에러 응답",
                                        content = {
                                                @Content(
                                                        mediaType = MediaType.APPLICATION_JSON_VALUE,
...
public @interface NonSecureApiInfo {}