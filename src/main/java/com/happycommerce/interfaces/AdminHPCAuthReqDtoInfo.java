...
import com.happycommerce.dto.AuthRequestDto;
...
@RouterOperations({
        @RouterOperation(
                ...
                @Operation(
                        ...
                        requestBody =
                        @RequestBody(
                                description = "HPC 통신 테스트 Request Dto",
                                required = true,
                                content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = AuthRequestDto.class,
                                        requiredProperties = {"hpcId", "hpcPwd"}))),
                        responses = {
                                @ApiResponse(
                                        responseCode = "200",
...
public @interface AdminHPCAuthReqDtoInfo {}